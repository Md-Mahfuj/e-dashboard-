...
const { user, setUser } = useState()
  ...
  return (
    <div className="flex flex-no-wrap ">
      <div 
      // className="h-screen hidden lg:block shadow-lg relative w-60"
      ...
      >
        <div className="bg-indigo-200 h-full">
          ...
          <nav className="mt-6">
            <div>
              <a
                className={getItemCss(sideBarItems.dashboard.key)}
                href="/dashboard"
              >
              ...
              <a
                className={getItemCss(sideBarItems.product.key)}
                href="/product"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="mx-4 text-sm font-normal">
                  {sideBarItems.product.value}
                </span>
              </a>
          
              <a className={getItemCss(sideBarItems.order.key)} href="/order">
                <span className="text-left">
                  <svg
                    width="20"
                    height="20"
                ...
                <span className="mx-4 text-sm font-normal">
                  {sideBarItems.order.value}
                </span>
              </a>
             
              
              <a onClick={logout} className={getItemCss("Logout")} href="#">
                <span className="text-left">
                  <svg
                    width="20"
                    fill="currentColor"
