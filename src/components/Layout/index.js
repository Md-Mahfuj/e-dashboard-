...
const Layout =({children,title})=> {
    return (
        <div className="flex flex-no-wrap">
            ...
            <DashSidebar title={sideBarItems.dashboard.key}/>
            {/* Sidebar starts */}
            {/* Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] */}
            {/* <div className="w-64 absolute sm:relative bg-indigo-100 shadow md:h-full flex-col justify-between hidden sm:flex">
                <div>
                    ...
                    <div className="flex items-center mt-20 mb-4 px-8">
